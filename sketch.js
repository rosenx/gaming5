...
class Asteroid {
  ...
  breakup() {
    if (this.r < 20) return [];
    return [new Asteroid(this.pos, this.r / 2), new Asteroid(this.pos, this.r / 2)];
  }
...
class Laser {
  ...
  hits(ast) {
    return dist(this.pos.x, this.pos.y, ast.pos.x, ast.pos.y) < ast.r;
  }
